...
public class CameraScript : MonoBehaviour
{
	...
	void Start()
	{
		...
		background.GetComponent<SpriteRenderer>().sprite = Background[PlayerPrefs.GetInt("stage", 0)];
		ground.GetComponent<SpriteRenderer>().sprite = Ground[PlayerPrefs.GetInt("stage", 0)];
	}
